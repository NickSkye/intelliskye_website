        ...
        <div class="col-sm-5 left-col">
            <div class="top-margin">
                <div class="text-center" data-aos="fade-up">
                    <h2 class="orange-top">Only in Newport Beach<br>can you energize yourself with<br>Deep Heat Crystal Therapy.</h2>
                </div>
                <div class="text-center">
                    <img src="/images/2.png" alt="" data-aos="flip-left" data-aos-delay="200" data-aos-easing="ease-in-sine">
                </div>
            </div>
        </div>
        <div class="col-sm-7">
            <div>
                <div id="myCarousel" class="carousel slide vertical" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="item">
                            <a href="/about-crystal">
                            <img src="/images/7.png" alt="7" style="width:100%;">
                            </a>
                        ...
                        <div class="item">
                            <a href="/about-crystal">
                            <img src="/images/8.png" alt="8" style="width:100%;">
                            </a>
                            {{--<div class="carousel-caption">--}}
                                {{--<h3>New York</h3>--}}
                        ...
                        <div class="item">
                            <a href="/about-crystal">
                            <img src="/images/9.png" alt="9" style="width:100%;">
                            </a>
                            {{--<div class="carousel-caption">--}}
                            {{--<h3>New York</h3>--}}
                            {{--<p>We love the Big Apple!</p>--}}
                        ...
                        <div class="item">
                            <a href="/about-crystal">
                            <img src="/images/10.png" alt="10" style="width:100%;">
                            </a>
                            {{--<div class="carousel-caption">--}}
                            {{--<h3>New York</h3>--}}
                            {{--<p>We love the Big Apple!</p>--}}
                        ...
                        <div class="item">
                            <a href="/about-crystal">
                            <img src="/images/11.png" alt="11" style="width:100%;">
                            </a>
                            {{--<div class="carousel-caption">--}}
                            {{--<h3>New York</h3>--}}
                            {{--<p>We love the Big Apple!</p>--}}
